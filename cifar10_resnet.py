...
resnet50_model = ResNet50(weights='imagenet',include_top=False,input_shape=(min_dim,min_dim,3))
print("Number of layers needs to be excluded from training: {}".format(len(resnet50_model.layers)))

# Finetuning model
topmodel = Flatten()(resnet50_model.output)
topmodel = (Dense(10))(topmodel)
topmodel = (Activation('softmax'))(topmodel)

model = Model(inputs=resnet50_model.input,outputs=topmodel)
